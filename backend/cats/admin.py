...
class CatAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ('Basic Information', {
            'fields': ['name', 'breed', 'age', 'color', 'weight']
        }),
        ('Medical Information', {
            'fields': ['is_neutered']
        }),
        ('Adoption Information', {
            'fields': ['owner_name', 'adoption_date']
        }),
        ('Additional Information', {
            'fields': ['description']
        }),
        ('System Information', {
            'fields': ['id', 'created_at', 'is_adopted', 'age_display', 'weight_display', 'status_display'],
            'classes': ['collapse']
        }),
    ]
    ...
    def mark_as_adopted(self, request, queryset):
        ...
        self.message_user(
            request,
            f'{count} cats marked as adopted.'
        )
    ...
    def mark_as_available(self, request, queryset):
        ...
        self.message_user(
            request,
            f'{count} cats marked as available for adoption.'
        )
