    ...
    def statistics(self, request: Request) -> Response:
        ...
        try:
            ...
            stats_data = {
                ...
                'average_age': round(age_stats['average_age'], 1) if age_stats['average_age'] else None,
        ...
        try:
            ...
            for breed_data in breeds:
                ...
                breed_stats.append({
                    ...
                    'count': count,
                    'adoption_rate': round(adoption_rate, 2),
                    'average_age': round(breed_data['average_age'], 1) if breed_data['average_age'] else None,
                    'average_weight': round(float(breed_data['average_weight']), 2) if breed_data['average_weight'] else None,
                })
